...
# Definimos los tipos de los argumentos de la función _procesarNumero
libApi._procesarNumero.argtypes = (ctypes.c_float,)

# Definimos el tipo del retorno de la función _procesarNumero
libApi._procesarNumero.restype = ctypes.c_int
...
if response.status_code == 200:
    ...
    if value_found is not None:
        ...
        # Llamar a C
        print("Llamando a la función _procesarNumero de C: " + str(libApi._procesarNumero(value_found)))# Llamamos a la función _procesarNumero
    else:
